defmodule Vera.ServicesTest do
  ...
  describe "services" do
    ...
    test "create_service/1 broadcasts to appropriate topics for root service" do
      Phoenix.PubSub.subscribe(Vera.PubSub, "services")
    ...
    test "create_service/1 broadcasts to appropriate topics for child service" do
      ...
      Phoenix.PubSub.subscribe(Vera.PubSub, "service/#{parent.id}")
    ...
    test "update_service/2 broadcasts updates and path changes" do
      ...
      Phoenix.PubSub.subscribe(Vera.PubSub, "service/#{child.id}")
      Phoenix.PubSub.subscribe(Vera.PubSub, "service/#{parent.id}")
      Phoenix.PubSub.subscribe(Vera.PubSub, "service/#{grandchild.id}")
