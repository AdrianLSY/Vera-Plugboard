defmodule PlugboardWeb.Accounts.AccountAuth do
  ...
  @remember_me_cookie "_plugboard_web_account_remember_me"
  ...
  def log_out_account(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      PlugboardWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_account:
      ...
      defmodule PlugboardWeb.PageLive do
        use PlugboardWeb, :live_view

        on_mount {PlugboardWeb.Accounts.AccountAuth, :mount_current_account}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{PlugboardWeb.Accounts.AccountAuth, :ensure_authenticated}] do
